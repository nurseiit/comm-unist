...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p2, p0, Lcom/google/android/gms/internal/zzcar;->zzbfr:Landroid/os/HandlerThread;

    iget-object p2, p0, Lcom/google/android/gms/internal/zzcar;->zzbfr:Landroid/os/HandlerThread;

    invoke-virtual {p2}, Landroid/os/HandlerThread;->start()V

    new-instance p2, Lcom/google/android/gms/internal/zzcas;

    iget-object p3, p0, Lcom/google/android/gms/internal/zzcar;->zzbfr:Landroid/os/HandlerThread;

    invoke-virtual {p3}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object p3

    invoke-direct {p2, p1, p3, p0, p0}, Lcom/google/android/gms/internal/zzcas;-><init>(Landroid/content/Context;Landroid/os/Looper;Lcom/google/android/gms/common/internal/zzf;Lcom/google/android/gms/common/internal/zzg;)V

    iput-object p2, p0, Lcom/google/android/gms/internal/zzcar;->zzbfo:Lcom/google/android/gms/internal/zzcas;

    new-instance p1, Ljava/util/concurrent/LinkedBlockingQueue;

    invoke-direct {p1}, Ljava/util/concurrent/LinkedBlockingQueue;-><init>()V

    iput-object p1, p0, Lcom/google/android/gms/internal/zzcar;->zzbfq:Ljava/util/concurrent/LinkedBlockingQueue;

    iget-object p1, p0, Lcom/google/android/gms/internal/zzcar;->zzbfo:Lcom/google/android/gms/internal/zzcas;

    invoke-virtual {p1}, Lcom/google/android/gms/internal/zzcas;->zzrb()V
...
.method public final onConnected(Landroid/os/Bundle;)V
    ...
    iget-object v1, p0, Lcom/google/android/gms/internal/zzcar;->packageName:Ljava/lang/String;

    iget-object v2, p0, Lcom/google/android/gms/internal/zzcar;->zzbfp:Ljava/lang/String;

    invoke-direct {v0, v1, v2}, Lcom/google/android/gms/internal/zzcat;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-interface {p1, v0}, Lcom/google/android/gms/internal/zzcax;->zza(Lcom/google/android/gms/internal/zzcat;)Lcom/google/android/gms/internal/zzcav;

    move-result-object p1

    invoke-virtual {p1}, Lcom/google/android/gms/internal/zzcav;->zzvA()Lcom/google/android/gms/internal/zzax;
    ...
    iget-object p1, p0, Lcom/google/android/gms/internal/zzcar;->zzbfr:Landroid/os/HandlerThread;
    ...
    :catch_1
    :try_start_1
    iget-object p1, p0, Lcom/google/android/gms/internal/zzcar;->zzbfq:Ljava/util/concurrent/LinkedBlockingQueue;
...
.method public final zzbe(I)Lcom/google/android/gms/internal/zzax;
    ...
    check-cast p1, Lcom/google/android/gms/internal/zzax;
    :try_end_0
    .catch Ljava/lang/InterruptedException; {:try_start_0 .. :try_end_0} :catch_0
