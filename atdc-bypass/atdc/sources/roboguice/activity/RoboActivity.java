...
public class RoboActivity extends Activity implements RoboContext {
    ...
    protected static boolean shouldInjectOnCreateView(String str) {
        return false;
    }
    ...
    public View onCreateView(String str, Context context, AttributeSet attributeSet) {
        if (shouldInjectOnCreateView(str)) {
            return injectOnCreateView(str, context, attributeSet);
        }
    ...
    protected static View injectOnCreateView(String str, Context context, AttributeSet attributeSet) {
        try {
            View view = (View) Class.forName(str).getConstructor(new Class[]{Context.class, AttributeSet.class}).newInstance(new Object[]{context, attributeSet});
