...
public final class WalletFragmentOptions extends zza implements ReflectedParcelable {
    ...
    public final class Builder {
        ...
        public final Builder setEnvironment(int i) {
            WalletFragmentOptions.this.zzbPT = i;
            return this;
        }

        public final Builder setFragmentStyle(int i) {
            WalletFragmentOptions.this.zzbQv = new WalletFragmentStyle().setStyleResourceId(i);
            return this;
        }

        public final Builder setFragmentStyle(WalletFragmentStyle walletFragmentStyle) {
            WalletFragmentOptions.this.zzbQv = walletFragmentStyle;
            return this;
        }

        public final Builder setMode(int i) {
            WalletFragmentOptions.this.zzaLU = i;
            return this;
        }
    ...
    public static Builder newBuilder() {
        ...
        return new Builder(walletFragmentOptions, null);
    }
