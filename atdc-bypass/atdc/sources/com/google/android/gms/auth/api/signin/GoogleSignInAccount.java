...
public class GoogleSignInAccount extends zza implements ReflectedParcelable {
    ...
    public static GoogleSignInAccount zzbP(@Nullable String str) throws JSONException {
        ...
        if (valueOf == null) {
            valueOf = Long.valueOf(zzalN.currentTimeMillis() / 1000);
        }
        GoogleSignInAccount googleSignInAccount = r3;
        GoogleSignInAccount googleSignInAccount2 = new GoogleSignInAccount(3, optString2, optString3, optString4, optString5, parse, null, valueOf.longValue(), zzbo.zzcF(string), new ArrayList((Collection) zzbo.zzu(hashSet)), optString6, optString7);
