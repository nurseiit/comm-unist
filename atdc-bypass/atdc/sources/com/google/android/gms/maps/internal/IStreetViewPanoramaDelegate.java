...
public interface IStreetViewPanoramaDelegate extends IInterface {
    ...
    void setOnStreetViewPanoramaCameraChangeListener(zzbf zzbf) throws RemoteException;

    void setOnStreetViewPanoramaChangeListener(zzbh zzbh) throws RemoteException;

    void setOnStreetViewPanoramaClickListener(zzbj zzbj) throws RemoteException;

    void setOnStreetViewPanoramaLongClickListener(zzbl zzbl) throws RemoteException;
