...
public final class WakeLockEvent extends StatsEvent {
    ...
    public final String zzrW() {
        ...
        Object join = this.zzaJt == null ? "" : TextUtils.join(",", this.zzaJt);
        String valueOf5 = String.valueOf("\t");
        int i2 = this.zzaJw;
        String valueOf6 = String.valueOf("\t");
        Object obj = this.zzaJq == null ? "" : this.zzaJq;
        String valueOf7 = String.valueOf("\t");
        Object obj2 = this.zzaJx == null ? "" : this.zzaJx;
        String valueOf8 = String.valueOf("\t");
        float f = this.zzaJy;
        String valueOf9 = String.valueOf("\t");
        float f2 = f;
        Object obj3 = this.zzaJr == null ? "" : this.zzaJr;
        int i3 = i2;
        StringBuilder stringBuilder = new StringBuilder(((((((((((((String.valueOf(valueOf).length() + 37) + String.valueOf(valueOf2).length()) + String.valueOf(valueOf3).length()) + String.valueOf(valueOf4).length()) + String.valueOf(join).length()) + String.valueOf(valueOf5).length()) + String.valueOf(valueOf6).length()) + String.valueOf(obj).length()) + String.valueOf(valueOf7).length()) + String.valueOf(obj2).length()) + String.valueOf(valueOf8).length()) + String.valueOf(valueOf9).length()) + String.valueOf(obj3).length());
