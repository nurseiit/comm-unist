...
public class GoogleCloudMessaging {
    ...
    private final Intent zza(Bundle bundle, boolean z) throws IOException {
        if (Looper.getMainLooper() == Looper.myLooper()) {
            ...
            try {
                return (Intent) this.zzbfS.poll(NotificationOptions.SKIP_STEP_THIRTY_SECONDS_IN_MS, TimeUnit.MILLISECONDS);
    ...
    private final synchronized String zza(boolean z, String... strArr) throws IOException {
        ...
        if (zzbd.contains(".gsf")) {
            ...
            return InstanceID.getInstance(this.zzqD).getToken(zzc, INSTANCE_ID_SCOPE, bundle);
        }
        bundle.putString("sender", zzc);
        Intent zza = zza(bundle, z);
        zzc = GCMManager.PROPERTY_REG_ID;
        if (zza == null) {
            throw new IOException("SERVICE_NOT_AVAILABLE");
        }
        zzc = zza.getStringExtra(zzc);
        if (zzc != null) {
            return zzc;
        }
        String stringExtra = zza.getStringExtra(MediaRouteProviderProtocol.SERVICE_DATA_ERROR);
        if (stringExtra != null) {
        ...
        if (zzbd.contains(".gsf")) {
            ...
            for (String zzbd2 : bundle.keySet()) {
                ...
                if (obj instanceof String) {
                    ...
                    bundle2.putString(zzbd2.length() != 0 ? str4.concat(zzbd2) : new String(str4), (String) obj);
                }
            }
