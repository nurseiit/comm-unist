...
public final class CallServerInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if (PreviewActivity.ON_CLICK_LISTENER_CLOSE.equalsIgnoreCase(build.request().header("Connection")) || PreviewActivity.ON_CLICK_LISTENER_CLOSE.equalsIgnoreCase(build.header("Connection"))) {
            streamAllocation.noNewStreams();
        }
