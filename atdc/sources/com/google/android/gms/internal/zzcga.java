...
public final class zzcga {
    ...
    /* synthetic */ zzcga(zzcfw zzcfw, String str, long j, zzcfx zzcfx) {
        this(zzcfw, str, j);
    }
    ...
    public final void zzf(String str, long j) {
        ...
        j = this.zzbrF.zzaix.getLong(this.zzbrI, 0);
        if (j <= 0) {
            Editor edit = this.zzbrF.zzaix.edit();
        ...
        long j2 = j + 1;
        Object obj = (this.zzbrF.zzwB().zzzt().nextLong() & Long.MAX_VALUE) < Long.MAX_VALUE / j2 ? 1 : null;
        Editor edit2 = this.zzbrF.zzaix.edit();
        if (obj != null) {
            edit2.putString(this.zzbrJ, str);
        }
        edit2.putLong(this.zzbrI, j2);
        edit2.apply();
    }
