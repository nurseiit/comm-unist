...
public final class MaskedWallet extends zza implements ReflectedParcelable {
    ...
    public final class Builder {
        ...
        /* synthetic */ Builder(MaskedWallet maskedWallet, zzp zzp) {
            this();
        }
    ...
    public static Builder newBuilderFrom(MaskedWallet maskedWallet) {
        ...
        Builder email = new Builder(maskedWallet2, null).setGoogleTransactionId(maskedWallet.getGoogleTransactionId()).setMerchantTransactionId(maskedWallet.getMerchantTransactionId()).setPaymentDescriptions(maskedWallet.getPaymentDescriptions()).setInstrumentInfos(maskedWallet.getInstrumentInfos()).setEmail(maskedWallet.getEmail());
