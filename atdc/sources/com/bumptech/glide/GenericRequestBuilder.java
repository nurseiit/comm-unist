...
public class GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> implements Cloneable {
    ...
    private Request buildRequestRecursive(Target<TranscodeType> target, ThumbnailRequestCoordinator thumbnailRequestCoordinator) {
        ...
        if (this.thumbnailRequestBuilder != null) {
            ...
            thumbnailRequestCoordinator2.setRequests(obtainRequest, this.thumbnailRequestBuilder.buildRequestRecursive(target, thumbnailRequestCoordinator2));
    ...
    private Request obtainRequest(Target<TranscodeType> target, float f, Priority priority, RequestCoordinator requestCoordinator) {
        ...
        return GenericRequest.obtain(childLoadProvider, obj, key, context, priority, target, f, drawable, i, drawable2, i2, requestListener, requestCoordinator, engine, transformation2, cls, z, glideAnimationFactory, i3, this.overrideHeight, this.diskCacheStrategy);
    }
}
